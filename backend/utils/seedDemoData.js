...
/*
        ...
        */
        ...
        await UserProgress.create({
            ...
            totalStudyTime: 14400, // 4 hours
            pomodoroSessions: 6,
            quizzesTaken: 12,
            topicMastery: [
                { topic: 'Fourier Series', accuracy: 85, attempts: 5, lastStudied: new Date() },
                { topic: 'Data Structures', accuracy: 62, attempts: 7, lastStudied: new Date() },
                { topic: 'Operating Systems', accuracy: 45, attempts: 3, lastStudied: new Date() }
            ],
            recentActivity: [
                { activityType: 'quiz', description: 'Quiz on Fourier Series', score: 80, timestamp: new Date(Date.now() - 3600000) },
                { activityType: 'study_session', description: 'Deep Work on Data Structures', duration: 1800, timestamp: new Date(Date.now() - 7200000) },
                { activityType: 'pomodoro', description: 'Pomodoro Session', duration: 1500, timestamp: new Date(Date.now() - 10800000) }
            ],
            quizHistory: [
                { topic: 'Fourier Series', question: 'What is Dirichlet condition?', userAnswer: 'Correct condition', correctAnswer: 'Correct condition', isCorrect: true, timestamp: new Date(Date.now() - 3600000) },
                { topic: 'Data Structures', question: 'What is O(n)?', userAnswer: 'Linear', correctAnswer: 'Linear', isCorrect: true, timestamp: new Date(Date.now() - 7200000) }
            ]
        });
        ...
        if (currentUser) {
            ...
            currentUser.badges = ['Early Bird', 'Consistency King'];
