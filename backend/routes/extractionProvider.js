...
const getGeminiModel = (modelName = 'gemini-3-flash-preview', forceNext = false) => {
...
const FILE_EXTRACTION_PROMPT = `You are an expert academic document parser. Extract all textual content precisely. Maintain headings, lists, and hierarchical structure. decipher handwriting if found. Return ONLY clean extracted text. Do not add commentary or "Here is the text".`;
